...
public void  ball () {
	fill(cBall);
	stroke(c2);
	ellipse((float)  ball.getCenterX() , (float) ball.getCenterY (), (float) 
	ball.getWidth(), (float) ball.getHeight ()) ;
}

public void paddle1 () {
	fill(c1) ;
	stroke (c2);
	rect((float) paddle1.getX (),  (float) paddle1.getY() ,  (float) paddle1.getWidth() ,          
	(float)  paddle1.getHeight()	,  (float) paddle1.getWidth()  /  2) ;
}	

public void paddle2 () {
	fill(c1) ;
	stroke (c2);
	rect((float) paddle2.getX (),  (float) paddle2.getY() ,  (float) paddle2.getWidth() ,          
	(float)  paddle2.getHeight()	,  (float) paddle2.getWidth()  /  2) ;
}
